...
import { VbenRenderContent } from '@/@core/ui-kit/shadcn-ui'
...
const renderLink = (href: string, text: string) =>
  h('a', { href, target: '_blank', class: 'vben-link' }, { default: () => text })
...
const vbenDescriptionItems: DescriptionItem[] = [
  ...
  {
    content: renderLink('https://github.com/programClown/supersonic-app', '点击查看'),
    title: 'Github'
  },
  {
    content: h('div', [
