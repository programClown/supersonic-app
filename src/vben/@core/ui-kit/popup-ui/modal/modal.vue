...
import { Expand, Shrink } from '@vben/@core/base/icons';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@vben/@core/base/shared/constants';
import { globalShareState } from '@vben/@core/base/shared/global-state';
import { cn } from '@vben/@core/base/shared/utils';
